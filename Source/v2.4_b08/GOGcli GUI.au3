...
Global $7zip, $a, $addlist, $alert, $alerts, $alf, $alldetail, $alldown, $allgames, $allkeys, $alpha, $ans, $array, $backups, $bigcover, $bigpic, $blackjpg
...
Global $downfiles, $downlist, $download, $downloads, $downlog, $drv, $entries, $entry, $erred, $existDB, $exists, $extbin, $extdmg, $extexe, $extpkg, $extsh, $extzip, $f, $file, $fileinfo, $filepth, $files
...
;~ 										EndIf
		...
		Case $msg = $Item_downall_opts
			...
			; Small GUI with a few options. Perhaps larger now, to include choices like - OS, Installer Files, Patch files, Extras.
