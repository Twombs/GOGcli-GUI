...
Global $purge, $r, $rat, $ratify, $read, $record, $relax, $reportexe, $res, $results, $ret, $return, $row, $s, $same, $savkeys, $savlog, $second, $selector
...
Func MainGUI()
	...
	Local $Item_downall_opts, $Item_downall_start, $Item_downall_view, $downall
	;
	...
	$Label_progress = GUICtrlCreateLabel("0%", 403, 136, 114, 20, $SS_CENTER + $SS_CENTERIMAGE)
